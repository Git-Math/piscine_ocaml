...
let life () =
	print_endline "Generation of an helix";
	let helix = generate_helix 199
	in print_endline (helix_to_string helix);
	print_endline "His complement";
	print_endline (helix_to_string (complementary_helix helix));
	print_endline "The RNA";
	let rna = generate_rna helix
	in print_endline (rna_to_string rna);
	print_endline "And finally, the protein";
